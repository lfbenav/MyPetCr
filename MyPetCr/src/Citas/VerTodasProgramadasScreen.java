 ...
 * @author lfben
 */
public class VerTodasProgramadasScreen extends javax.swing.JFrame {

    public ArrayList<Cita> citas;
    public Cita citaSeleccionada = null;
    
    public VerTodasProgramadasScreen(JFrame referencia) {
        initComponents();
    ...
    public void cargarListaCitas(){
        ...
        this.citas = CitasAccess.getCitasProgramadas();
