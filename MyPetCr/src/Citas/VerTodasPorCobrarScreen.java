 ...
 * @author lfben
 */
public class VerTodasPorCobrarScreen extends javax.swing.JFrame {

    public ArrayList<Cita> citas;
    public Cita citaSeleccionada = null;
    
    public VerTodasPorCobrarScreen(JFrame referencia) {
        initComponents();
    ...
    public void cargarListaCitas(){
        ...
        this.citas = CitasAccess.getCitasPorCobrar();
        
        for(Cita c : this.citas){
            lista.addElement(" ("+ c.idCita + ") "+ c.fecha + ", a las " + c.hora + " Cliente: " + c.nombreCliente + " Veterinario: " + c.nombreVeterinario);
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Citas por Cobrar");
        ...
        btnCobrar.setBackground(new java.awt.Color(224, 123, 79));
        btnCobrar.setFont(new java.awt.Font("Segoe UI Light", 1, 14)); // NOI18N
    ...
    private void listaCitasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_listaCitasMouseClicked
        ...
        for(Cita c : this.citas){
            if((" ("+ c.idCita + ") "+ c.fecha + ", a las " + c.hora + " Cliente: " + c.nombreCliente + " Veterinario: " + c.nombreVeterinario).equals(seleccion)){
                citaSeleccionada = c;
            }
        }
    ...
    private void btnCobrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCobrarActionPerformed
        ...
        new CobrarCitaScreen(this, citaSeleccionada).setVisible(true);
