 ...
 * @author lfben
 */
public class VerTodasCobradasScreen extends javax.swing.JFrame {

    public ArrayList<String> citas;
    
    public VerTodasCobradasScreen(JFrame referencia) {
        initComponents();
    ...
    public void cargarListaCitas(){
        ...
        this.citas = CitasAccess.getReciboTodasCitas();
        
        for(String c : this.citas){
            lista.addElement(c);
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Historial de Citas");
