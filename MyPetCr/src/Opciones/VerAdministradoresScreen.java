 ...
 * @author lfben
 */
public class VerAdministradoresScreen extends javax.swing.JFrame {

    ArrayList<Administrador> administradores;
    int idSeleccionado = -1;
    
    public VerAdministradoresScreen(MenuUsuario referencia) {
        initComponents();
    ...
    private void cargarListaUsuarios(){
        ...
        this.administradores = UsuariosAccess.getAdministradores();
        
        for(Administrador a : administradores){
            lista.addElement(" ("+ a.correo + ") "+ a.nombre);
        }
        
    }
    
    private Administrador validarCamposEditarUsuario(){
        ...
        return new Administrador(-1,correo,-1,nombre,celular);
    }
    ...
    private void initComponents() {
        ...
        btnBorrar.setBackground(new java.awt.Color(224, 123, 79));
        btnBorrar.setFont(new java.awt.Font("Segoe UI Light", 1, 14)); // NOI18N
    ...
    private Administrador buscarUsuarioEnLista(String elemento){
            for(Administrador a : this.administradores){
            if((" ("+ a.correo + ") "+ a.nombre).equals(elemento)){
                idSeleccionado = a.id;
                return a;
            }
        }
    ...
    private void listaUsuariosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_listaUsuariosMouseClicked
        ...
        Administrador seleccionado = buscarUsuarioEnLista(seleccion);
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        Administrador modificar =  validarCamposEditarUsuario();
        if(modificar == null){
    ...
    private void btnBorrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBorrarActionPerformed
        UsuariosAccess.deleteAdministrador(idSeleccionado);
