 ...
 * @author lfben
 */
public class HistorialCompraScreen extends javax.swing.JFrame {

    public Cliente cliente;
    
    public HistorialCompraScreen(JFrame referencia, Cliente cliente) {
        initComponents();
    ...
    private void cargarHistorial(){
        ArrayList<String> s = ComprasAccess.getHistorialUsuario(cliente.id);
        DefaultListModel lista = new DefaultListModel();
        listaHistorial.setModel(lista);
    ...
    private void initComponents() {
        ...
        listaHistorial.setBackground(new java.awt.Color(237, 241, 242));
        listaHistorial.setFont(new java.awt.Font("Segoe UI Light", 0, 14)); // NOI18N
        listaHistorial.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                listaHistorialMouseClicked(evt);
            }
        });
    ...
    private void listaHistorialMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_listaHistorialMouseClicked

    }//GEN-LAST:event_listaHistorialMouseClicked
