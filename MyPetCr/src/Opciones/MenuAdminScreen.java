 ...
 * @author lfben
 */
public class MenuAdminScreen extends MenuUsuario{

    eCommerceScreen referencia;
    
    public MenuAdminScreen(eCommerceScreen referencia) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Tipo de usuario: Administrador");
    ...
    private void btnRegistrarUsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarUsuarioActionPerformed
        MenuAdminScreen estaVentana = this;
    ...
    private void btnVerClientesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVerClientesActionPerformed
        ...
        VerClientesScreen nuevaVentana = new VerClientesScreen(estaVentana, Usuario.ADMINISTRADOR);
        nuevaVentana.addWindowListener(new java.awt.event.WindowAdapter() {
            @Override
            public void windowClosing(java.awt.event.WindowEvent windowEvent) {
                estaVentana.setVisible(true);
